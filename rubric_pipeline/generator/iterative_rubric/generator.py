...
from rubric_pipeline.generator.iterative_rubric.categorizer import LLMRubricCategorizer
from rubric_pipeline.generator.iterative_rubric.mcr_selector import SuperFastAdaptiveMCR2
...
from rubric_pipeline.generator.llm_grader_generator import (
    LLMGraderGenerator,
    LLMGraderGeneratorConfig,
)
from rubric_pipeline.graders.llm_grader import LLMGrader
from rubric_pipeline.graders.schema import GraderMode
...
from rubric_pipeline.utils.vision import TASK_T2I, normalize_task_type
...
class IterativeRubricsGeneratorConfig(LLMGraderGeneratorConfig):
    ...
    def __post_init__(self):
        ...
        if isinstance(self.language, str):
            self.language = LanguageEnum(self.language)
    ...
    async def generate(
        ...
        **kwargs,
        ...
        if hasattr(self.config, "custom_evaluation_prompt") and self.config.custom_evaluation_prompt is not None:
            ...
            grader_kwargs["template"] = get_evaluation_template(
                self.config.grader_mode,
